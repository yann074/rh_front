...
const api = axios.create({
  ...
  withCredentials: true, // Adicionado para melhor compatibilidade com o Sanctum
});

// Este é o interceptor. Ele "intercepta" cada requisição antes de ela ser enviada.
api.interceptors.request.use(
  (config: InternalAxiosRequestConfig) => {
    // 1. Pega o token de autenticação que você salvou no localStorage após o login.
...
// É uma boa prática exportar a instância 'api' diretamente também.
export default api;